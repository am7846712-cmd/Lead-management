...
import { ArrowLeft, Search, Plus, Minus, Save, Send } from 'lucide-react';
  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <div>
        ...
        <h1 className="text-gray-900">Create Estimate</h1>
        <p className="text-gray-600 mt-1">Build a new estimate for your customer</p>
      </div>
          ...
          {selectedItems.length > 0 && (
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
              ...
              <div className="mt-6 space-y-3">
                <button className="w-full flex items-center justify-center gap-2 px-4 py-3 bg-white border border-gray-300 text-gray-700 rounded-lg hover:bg-gray-50 transition">
                  <Save className="w-4 h-4" />
                  Save as Draft
                </button>
                <button
                  onClick={handleSubmit}
                  className="w-full flex items-center justify-center gap-2 px-4 py-3 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition shadow-lg"
                >
